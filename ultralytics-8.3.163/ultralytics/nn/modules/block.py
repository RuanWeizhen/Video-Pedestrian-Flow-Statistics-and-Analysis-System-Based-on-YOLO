...
class EMA(nn.Module):
    ...
    def __init__(self, channels, factor=8):
        ...
        self.gn = nn.GroupNorm(num_groups=1, num_channels=group_channels)

    def forward(self, x):
        b, c, h, w = x.size()
        g = self.groups
        x_group = x.reshape(b * g, c // g, h, w)
        ...
        x1 = self.gn(x_group * x_h.sigmoid() * x_w.sigmoid())
        ...
        out = (x_group * weights.sigmoid()).reshape(b, c, h, w)
        return out